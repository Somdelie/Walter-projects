-- CreateEnum
CREATE TYPE "ProductType" AS ENUM ('WINDOW', 'DOOR', 'PROFILE', 'ACCESSORY', 'GLASS', 'HARDWARE');
...
-- CreateEnum
CREATE TYPE "PaymentMethod" AS ENUM ('CASH_ON_DELIVERY', 'CASH_ON_COLLECTION', 'CARD_ONLINE', 'EFT', 'BANK_TRANSFER');

-- CreateEnum
CREATE TYPE "PaymentStatus" AS ENUM ('PENDING', 'PAID', 'FAILED', 'REFUNDED', 'PARTIALLY_REFUNDED');

-- CreateEnum
CREATE TYPE "DeliveryMethod" AS ENUM ('DELIVERY', 'COLLECTION');
...
CREATE TABLE "Order" (
    ...
    "isNewOrder" BOOLEAN NOT NULL DEFAULT true,
