  ...
  return (
    <section className="relative bg-gradient-to-br from-gray-50 via-white to-gray-100 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900 text-gray-900 dark:text-white overflow-hidden min-h-screen flex items-center">
      ...
      <div className="absolute inset-0">
        ...
        />
        <motion.div
          className="absolute bottom-20 right-20 w-96 h-96 bg-orange-400/10 dark:bg-orange-500/20 rounded-full blur-3xl"
          animate={{
            scale: [1.2, 1, 1.2],
            opacity: [0.2, 0.5, 0.2],
          }}
        ...
        {/* Geometric Shapes */}
        <motion.div
          className="absolute top-1/4 right-1/4 w-2 h-2 bg-orange-500 dark:bg-orange-400 rounded-full"
          animate={{
            scale: [1, 1.5, 1],
            opacity: [0.4, 0.8, 0.4],
          }}
      ...
      <div className="container mx-auto px-4 py-20 relative">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            >
              <Badge className="bg-orange-500/20 dark:bg-orange-400/20 text-orange-700 dark:text-orange-300 border-orange-500/30 dark:border-orange-400/30 hover:bg-orange-500/30 dark:hover:bg-orange-400/30 px-4 py-2">
                <motion.div
                  animate={{ rotate: 360 }}
            ...
            <div className="space-y-4">
              ...
              >
                ...
                <br />
                <motion.span
                  className="bg-gradient-to-r from-orange-500 via-orange-400 to-orange-600 bg-clip-text text-transparent inline-block"
                  animate={{
            ...
            >
              {[
                ...
                { icon: Award, text: "ISO Certified", color: "text-orange-600 dark:text-orange-400" },
              ].map((feature, index) => (
                <motion.div
                  key={index}
                  initial={{ opacity: 0, scale: 0.8 }}
            ...
            >
              <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                <Button
                  asChild
                  size="lg"
                  className="bg-orange-500 hover:bg-orange-600 dark:bg-orange-400 dark:hover:bg-orange-500 text-white dark:text-black font-semibold px-8 py-6 text-lg group shadow-lg"
                >
                  <Link href="/products">
            ...
            >
              <motion.button
                ...
                whileTap={{ scale: 0.9 }}
                className="w-12 h-12 bg-orange-500 dark:bg-orange-400 text-black rounded-full flex items-center justify-center shadow-lg hover:shadow-xl transition-shadow"
              >
          ...
          >
            ...
            <div className="relative z-10">
              <motion.div whileHover={{ scale: 1.02, rotateY: 5 }} transition={{ duration: 0.6 }} className="relative">
                ...
                >
                  <svg width="300" height="60" viewBox="0 0 300 60" className="text-orange-500 dark:text-orange-400">
                    <motion.path
            ...
            <motion.div
              ...
              className="absolute inset-0 bg-gradient-to-r from-orange-400/20 to-blue-400/20 dark:from-orange-500/30 dark:to-blue-500/30 rounded-2xl -z-10"
            />
            <motion.div
              initial={{ opacity: 0, scale: 0.9, rotate: 0 }}
              animate={{ opacity: 0.05, scale: 1.1, rotate: -2 }}
              transition={{ delay: 0.7, duration: 1.2 }}
              className="absolute inset-0 bg-gradient-to-l from-blue-400/10 to-orange-400/10 dark:from-blue-500/20 dark:to-orange-500/20 rounded-2xl -z-20"
            />
          </motion.div>
        </div>
      </div>
