                ...
                <div className="flex flex-col space-y-1">
                  ...
                  {user && (
                    <>
                      ...
                      >
                        Wishlist
                        {wishlistCount > 0 && <Badge className="bg-red-600 text-white text-xs">{wishlistCount}</Badge>}
                      </Link>
                      ...
                      >
                        Cart
                        {itemCount > 0 && <Badge className="bg-blue-600 text-white text-xs">{itemCount}</Badge>}
                      </Link>
